# Домашнее задание к занятию "Платформа мониторинга Sentry" - Белов Михаил
...
![Configure Python SDK](./img/python_sdk.png)

В качестве решения задания пришлите скриншот меню Projects.

![App Error at Projects](./img/projects_app_error.png)
...
![Python Exception](./img/exception.png)

3. Перейдите в список событий проекта, выберите созданное вами и нажмите Resolved.
4. В качестве решения задание предоставьте скриншот Stack trace из этого события и список событий проекта после нажатия Resolved.

`После запуска приложения main.py доступ к sentry.io был заблокирован`

![Error 403](./img/403_error.png)
...
![Mail notification](./img/mail_notification.png)
